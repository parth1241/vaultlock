  ...
  return (
    <div className="min-h-screen bg-transparent">
      ...
      <main className="container mx-auto px-6 pt-32 pb-20">
        <Link href="/client/dashboard" className="inline-flex items-center text-slate-500 hover:text-amber-500 transition-colors mb-8 group">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                <Card className="bg-surface border-amber-900/20 shadow-xl">
                  <CardHeader>
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Input id="title" name="title" placeholder="e.g., E-commerce App Development" required className="bg-surface-high border-amber-900/10 focus:border-amber-500/50" />
                    </div>
                    <div className="space-y-2">
                      ...
                      <textarea 
                        id="description" 
                        name="description" 
                        className="w-full h-32 p-3 rounded-md bg-surface-high border border-amber-900/10 focus:border-amber-500/50 resize-none text-sm text-slate-200"
                ...
                <Card className="bg-surface border-amber-900/20 shadow-xl overflow-hidden">
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                      <CardTitle className="text-xl">Payment Milestones</CardTitle>
                    </div>
                    <Button type="button" onClick={addMilestone} variant="outline" size="sm" className="border-amber-500/30 text-amber-500 hover:bg-amber-500/10">
                      <Plus size={16} className="mr-1" /> Add Milestone
                    </Button>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {milestones.map((milestone, index) => (
                      <div key={index} className="flex items-end space-x-4 p-4 rounded-xl bg-surface-high/50 border border-amber-900/5 anim-slide-up">
                        <div className="flex-1 space-y-2">
                          ...
                          <Input 
                            ...
                            required 
                            className="bg-surface border-amber-900/10 h-10" 
                          />
                        </div>
              ...
              <div className="space-y-6">
                <Card className="bg-amber-500 border-none text-black sticky top-32">
                  <CardHeader>
                  ...
                  <CardFooter className="flex flex-col space-y-4">
                    <Button type="submit" className="w-full bg-black text-amber-500 hover:bg-zinc-900 h-14 text-xl font-bold rounded-2xl shadow-2xl transition-all hover:scale-[1.02]" disabled={loading}>
